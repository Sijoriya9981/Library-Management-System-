...
<td> <?php     echo  $row['book_price']?></td>
                  ...
                  <button class="btn "><a href="editbook.php?bn=<?php  echo  $row['book_no']; ?>">Edit</a> </button>
                  <button class="btn "><a href="deletebook.php?bn=<?php  echo  $row['book_no']; ?>">Delete</a> </button>
