...
<body>
 ...
 <div class="row">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="authorname" id=""  value="<?php  echo  $author_name; ?>" >
    </div>
...
if(isset($_POST['update']))
{
    ...
    $con  = mysqli_connect("localhost","root","");
    $db = mysqli_select_db($con,"LMS");
    $sql = "UPDATE `LMS`.`author` SET author_name = '$_POST[authorname]'
  
     where author_id = $_GET[aid]";
