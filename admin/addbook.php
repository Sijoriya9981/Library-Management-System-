 ...
 <div class="row">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <input type="text" class="form-control" name="bookauthor" id=""   required >
    </div>
    <div class="form-group">
        <label for="">Category Name:</label>
        <input type="text" class="form-control" name="categoryname" id=""  required    >
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="bookprice" id=""   required  >
    </div>    

    <button class="btn btn-primary" name="addbook">Add Book</button>
    </form>
...
$query = "INSERT into book VALUES (NULL,'$_POST[bookname]','$_POST[bookauthor]','$_POST[categoryname]',$_POST[bookno],$_POST[bookprice])";
