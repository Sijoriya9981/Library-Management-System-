...
<body>
 ...
 <div class="row">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="authorname" id=""    >
    </div>
    

    <button class="btn btn-primary" name="addauthor">Add Author</button>
    </form>
...
$query = "INSERT into author VALUES ('','$_POST[authorname]')";
