...
<body>
 ...
 <div class="row">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="bookname" id=""    required>
    </div>
     <div class="form-group">
        <label for="">Book Author:</label>
        <select name="bookauthor" id="" class="form-control">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="bookno" id=""  required    >
    </div>

    <div class="form-group">
        <label for="">Student Id:</label>
        <input type="text" class="form-control" name="studentid" id=""   required  >
    </div>

    <div class="form-group">
        <label for="">Issue Date</label>
        <input type="text" class="form-control" name="issuedate"  value="<?php   echo date("d-m-y");?>" id=""   required  >
    </div>    

    <button class="btn btn-primary" name="issuebook">Issue Book</button>
    </form>
...
{
  $sql = "INSERT INTO  issuebook VALUES(NULL,$_POST[bookno],'$_POST[bookname]','$_POST[bookauthor]',$_POST[studentid],1,'$_POST[issuedate]')";
