...
<td> <?php     echo  $row['cat_name']?></td>
                  ...
                  <button class="btn "><a href="editcategory.php ?cid=<?php  echo $row['cat_id'] ;  ?>">Edit</a> </button>
                  <button class="btn "><a href="deletecategory.php?cid=<?php  echo $row['cat_id'] ;?>">Delete</a> </button>
