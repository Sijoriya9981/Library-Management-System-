...
<td> <?php     echo  $row['author_name']?></td>
                  ...
                  <button class="btn "><a href="editauthor.php?aid=<?php  echo  $row['author_id'];?>">Edit</a> </button>
                  <button class="btn "><a href="deleteauthor.php?aid=<?php  echo  $row['author_id'];?>">Delete</a> </button>
